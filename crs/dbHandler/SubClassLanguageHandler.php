 ...
 * @Maatify   LanguagePortalHandler :: SubClassLanguageHandler
 */
...
abstract class SubClassLanguageHandler extends DbPortalHandler
{
    ...
    {
        $table = "`$this->tableName` " . LanguagePortal::obj()->JOINTableAdd($this->tableName);
        $columns = LanguagePortal::obj()->JoinShortName() . ", `$this->tableName`.*";
